...
func (q *Queries) getFilterInstancesQuery(selectPart exp.LiteralExpression, p types.InstancesQueryParams, duration shared.PostgresDuration) *goqu.SelectDataset {
