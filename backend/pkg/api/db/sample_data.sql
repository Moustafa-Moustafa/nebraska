...
insert into groups (id, name, description, policy_safe_mode, policy_office_hours, policy_timezone, policy_period_interval, policy_max_updates_per_period, policy_update_timeout, created_ts, application_id, channel_id, track) values ('9a2deb70-37be-4026-853f-bfdd6b347bbe', 'Stable', 'For production clusters', true, false, 'Europe/Berlin', '15 minutes', 2, '60 minutes', '2019-08-19 05:09:34.269062', 'e96281a6-d1af-4bde-9a0a-97b76e56dc57', 'e06064ad-4414-4904-9a6e-fd465593d1b2', 'stable');
insert into groups (id, name, description, policy_safe_mode, policy_office_hours, policy_timezone, policy_period_interval, policy_max_updates_per_period, policy_update_timeout, created_ts, application_id, channel_id, track) values ('3fe10490-dd73-4b49-b72a-28ac19acfcdc', 'Beta', 'Promoted alpha releases, to catch bugs specific to your configuration', true, false, 'Europe/Berlin', '15 minutes', 2, '60 minutes', '2019-08-19 05:09:34.273244', 'e96281a6-d1af-4bde-9a0a-97b76e56dc57', '128b8c29-5058-4643-8e67-a1a0e3c641c9', 'beta');
insert into groups (id, name, description, policy_safe_mode, policy_office_hours, policy_timezone, policy_period_interval, policy_max_updates_per_period, policy_update_timeout, created_ts, application_id, channel_id, track) values ('5b810680-e36a-4879-b98a-4f989e80b899', 'Alpha', 'Tracks current development work and is released frequently', true, false, 'Europe/Berlin', '15 minutes', 1, '30 minutes', '2019-08-19 05:09:34.274911', 'e96281a6-d1af-4bde-9a0a-97b76e56dc57', 'a87a03ad-4984-47a1-8dc4-3507bae91ee1', 'alpha');
insert into group_state (group_id, rollout_in_progress, safe_mode_disabled) values ('9a2deb70-37be-4026-853f-bfdd6b347bbe', false, false) on conflict (group_id) do update set rollout_in_progress = EXCLUDED.rollout_in_progress, safe_mode_disabled = EXCLUDED.safe_mode_disabled;
insert into group_state (group_id, rollout_in_progress, safe_mode_disabled) values ('3fe10490-dd73-4b49-b72a-28ac19acfcdc', true, false) on conflict (group_id) do update set rollout_in_progress = EXCLUDED.rollout_in_progress, safe_mode_disabled = EXCLUDED.safe_mode_disabled;
insert into group_state (group_id, rollout_in_progress, safe_mode_disabled) values ('5b810680-e36a-4879-b98a-4f989e80b899', false, false) on conflict (group_id) do update set rollout_in_progress = EXCLUDED.rollout_in_progress, safe_mode_disabled = EXCLUDED.safe_mode_disabled;
...
insert into groups (id, name, description, policy_safe_mode, policy_office_hours, policy_timezone, policy_period_interval, policy_max_updates_per_period, policy_update_timeout, created_ts, application_id, channel_id, track) values ('bcaa68bc-5f82-11e5-9d70-feff819cdc9f', 'Prod EC2 us-west-2', 'Production servers, west coast', true, false, 'Europe/Berlin', '15 minutes', 2, '60 minutes', '2019-08-19 05:09:34.269062', 'b6458005-8f40-4627-b33b-be70a718c48e', 'cb2deea8-5f83-11e5-9d70-feff819cdc9f', 'bcaa68bc-5f82-11e5-9d70-feff819cdc9f');
insert into groups (id, name, description, policy_safe_mode, policy_office_hours, policy_timezone, policy_period_interval, policy_max_updates_per_period, policy_update_timeout, created_ts, application_id, channel_id, track) values ('7074264a-2070-4b84-96ed-8a269dba5021', 'Prod EC2 us-east-1', 'Production servers, east coast', true, false, 'Europe/Berlin', '15 minutes', 2, '60 minutes', '2019-08-19 05:09:34.269062', 'b6458005-8f40-4627-b33b-be70a718c48e', 'cb2deea8-5f83-11e5-9d70-feff819cdc9f', '7074264a-2070-4b84-96ed-8a269dba5021');
insert into groups (id, name, description, policy_safe_mode, policy_office_hours, policy_timezone, policy_period_interval, policy_max_updates_per_period, policy_update_timeout, created_ts, application_id, channel_id, track) values ('b110813a-5f82-11e5-9d70-feff819cdc9f', 'Qa-Dev', 'QA and development servers, Sydney', true, false, 'Europe/Berlin', '15 minutes', 2, '60 minutes', '2019-08-19 05:09:34.269062', 'b6458005-8f40-4627-b33b-be70a718c48e', 'bfe32b4a-5f8c-11e5-9d70-feff819cdc9f', 'b110813a-5f82-11e5-9d70-feff819cdc9f');
insert into groups (id, name, description, policy_safe_mode, policy_office_hours, policy_timezone, policy_period_interval, policy_max_updates_per_period, policy_update_timeout, created_ts, application_id, channel_id, track) values ('cccccccc-5f82-11e5-9d70-feff819cdc9f', 'Failing Qa-Dev', 'Failing QA and development servers, Sydney', true, false, 'Europe/Berlin', '15 minutes', 2, '60 minutes', '2019-08-19 05:09:34.269062', 'b6458005-8f40-4627-b33b-be70a718c48e', 'dddddddd-5f83-11e5-9d70-feff819cdc9f', 'cccccccc-5f82-11e5-9d70-feff819cdc9f');
insert into group_state (group_id, rollout_in_progress, safe_mode_disabled) values ('bcaa68bc-5f82-11e5-9d70-feff819cdc9f', false, false) on conflict (group_id) do update set rollout_in_progress = EXCLUDED.rollout_in_progress, safe_mode_disabled = EXCLUDED.safe_mode_disabled;
insert into group_state (group_id, rollout_in_progress, safe_mode_disabled) values ('7074264a-2070-4b84-96ed-8a269dba5021', false, false) on conflict (group_id) do update set rollout_in_progress = EXCLUDED.rollout_in_progress, safe_mode_disabled = EXCLUDED.safe_mode_disabled;
insert into group_state (group_id, rollout_in_progress, safe_mode_disabled) values ('b110813a-5f82-11e5-9d70-feff819cdc9f', false, false) on conflict (group_id) do update set rollout_in_progress = EXCLUDED.rollout_in_progress, safe_mode_disabled = EXCLUDED.safe_mode_disabled;
insert into group_state (group_id, rollout_in_progress, safe_mode_disabled) values ('cccccccc-5f82-11e5-9d70-feff819cdc9f', false, false) on conflict (group_id) do update set rollout_in_progress = EXCLUDED.rollout_in_progress, safe_mode_disabled = EXCLUDED.safe_mode_disabled;
...
insert into groups (id, name, description, policy_safe_mode, policy_office_hours, policy_timezone, policy_period_interval, policy_max_updates_per_period, policy_update_timeout, created_ts, application_id, channel_id, track) values ('51a32aa9-3552-49fc-a28c-6543bccf0069', 'Master - dev', 'The latest stuff will be always here', true, false, 'Europe/Berlin', '15 minutes', 2, '60 minutes', '2019-08-19 05:09:34.269062', '780d6940-9a48-4414-88df-95ba63bbe9cb', 'a7c8c9a4-d2a3-475d-be64-911ff8d6e997', '51a32aa9-3552-49fc-a28c-6543bccf0069');
insert into group_state (group_id, rollout_in_progress, safe_mode_disabled) values ('51a32aa9-3552-49fc-a28c-6543bccf0069', false, false) on conflict (group_id) do update set rollout_in_progress = EXCLUDED.rollout_in_progress, safe_mode_disabled = EXCLUDED.safe_mode_disabled;
